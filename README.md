...
| [`marketing/lead-magnet/5-prompts.html`](marketing/lead-magnet/5-prompts.html) | **Lead magnet** (isca digital) | PDF "5 Prompts Prontos" para capturar e-mail/WhatsApp no topo do funil |
...
4. **Montar o funil de vendas?** Comece pelo [`marketing/lead-magnet/5-prompts.html`](marketing/lead-magnet/5-prompts.html) — abra no navegador, salve como PDF e use como isca digital.
